...
def fn(self, name='world'): # 先定义函数
    print('Hello, %s.' % name)
Hello2 = type('Hello2', (object,), dict(hello2=fn)) # 创建Hello class

# Hello2 相当于 class Hello2(object).......
...
# 简单的例子，这个metaclass可以给我们自定义的MyList增加一个add方法：
...
# __new__()方法接收到的参数依次是：cls, name, bases, attrs
# 1.当前准备创建的类的对象；
# 2.类的名字；
# 3.类继承的父类集合；
# 4.类的方法集合。
...
##########################################
# 遇到需要通过metaclass修改类定义的。ORM就是一个典型的例子。
